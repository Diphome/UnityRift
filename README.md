...
UnityRiftCLI <game folder> -m il2cpp --il2cpp-map Serializer              # compact name -> RVA JSON for a hook script
UnityRiftCLI <game folder> -m il2cpp --il2cpp-wire-layout LoginRequest_Serialize.c  # ordered on-the-wire layout
```
